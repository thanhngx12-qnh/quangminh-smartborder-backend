...
export class InitialSchema1759975907423 implements MigrationInterface {
    name = 'InitialSchema1759975907423'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "quotes" ("id" SERIAL NOT NULL, "customerName" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "phone" character varying(50), "serviceId" integer, "details" text NOT NULL, "status" character varying(50) NOT NULL DEFAULT 'PENDING', "aiSuggestedPrice" double precision, "adminNotes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_99a0e8bcbcd8719d3a41f23c263" PRIMARY KEY ("id"))`);
